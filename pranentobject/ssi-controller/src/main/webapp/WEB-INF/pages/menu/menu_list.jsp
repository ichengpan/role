...
<body>
	...
	<div id="menu_tb">
		<!-- Single button -->
		<div class="btn-group">
		  <button type="button" class="btn btn-success" onclick="show_add_dialog()">新增menuList</button>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function delete_checked_menu(id){
			$.ajax({
        		url:"<%=request.getContextPath() %>/menu/deleteMenu.jhtml",
        		data:{menuID:id},
        		dataType:"json",
        		type:"post",
